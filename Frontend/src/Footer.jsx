...
function Footer() {
  ...
  return (
    <div className={styles.footerbg}>
      <div className={`${styles.footer} ${styles.glass}`}>
        <div className={`${styles.wluglogo} ${styles.padding1rem}`}>
          <img src="https://i.ibb.co/KzppFLw/black.png" loading="lazy" alt="" />
          <div>
            <p>&#169; 2023 WCEWLUG, ALL RIGHTS RESERVED</p>
          </div>
        </div>
        <div className={`${styles.smedialinks} ${styles.padding1rem}`}>
          <p className={styles.stay_tuned}>Stay tuned!</p>
